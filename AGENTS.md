...
- Favicon and apple-touch-icon use `docs/public/brand/andre-lademann-favicon.png`. Keep PWA icons (`docs/public/pwa-192x192.png`, `docs/public/pwa-512x512.png`) derived from the same portrait.
