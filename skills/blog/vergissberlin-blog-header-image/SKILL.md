---
name: vergissberlin-blog-header-image
...
This skill belongs to the [Vergissberlin Skills](https://github.com/vergissberlin/skills) catalog. Invoke it as `vergissberlin-blog-header-image`.
