---
name: vergissberlin-blog-post-writer
...
This skill belongs to the [Vergissberlin Skills](https://github.com/vergissberlin/skills) catalog. Invoke it as `vergissberlin-blog-post-writer`.
...
`vergissberlin-blog-header-image` is a required companion skill for this workflow. Activate it and follow its complete instructions while creating the post; referencing it or reproducing only part of its guidance is not sufficient.
...
2. Invoke the activated `vergissberlin-blog-header-image` skill. In Codex or ChatGPT, use the built-in image-generation capability directly; do not merely return an image prompt.
