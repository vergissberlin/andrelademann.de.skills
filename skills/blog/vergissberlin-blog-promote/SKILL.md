---
name: vergissberlin-blog-promote
...
This skill belongs to the [Vergissberlin Skills](https://github.com/vergissberlin/skills) catalog. Invoke it as `vergissberlin-blog-promote`.
...
This skill is separate from `vergissberlin-blog-post-writer`. It works for every published article — freshly shipped or months old and only just brought back into focus.
