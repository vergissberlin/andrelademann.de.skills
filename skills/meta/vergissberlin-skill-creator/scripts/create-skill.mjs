...
const REPOSITORY_URL = 'https://github.com/vergissberlin/skills';
...
function buildSkillMarkdown(input, body) {
  ...
  return `---\nname: ${input.name}\ndescription: ${yamlString(input.description)}\nlicense: MIT\nmetadata:\n  version: ${input.version} # x-release-please-version\n  author: ${yamlString(AUTHOR)}\n  scope: ${input.domain}\n---\n\n# ${input.title}\n\nThis skill belongs to the [Vergissberlin Skills](${REPOSITORY_URL}) catalog. Invoke it as \`${input.name}\`.\n\n${instructions.trim()}\n`;
}
