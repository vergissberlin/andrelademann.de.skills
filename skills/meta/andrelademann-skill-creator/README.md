...
Create, refine, test, document, and register skills in the André Lademann Skills repository.

This skill is part of the [André Lademann Skills](https://github.com/vergissberlin/andrelademann.de.skills) catalog and is invoked as `andrelademann-skill-creator`.
...
pnpm typecheck
pnpm test:run
pnpm harness --skill andrelademann-skill-creator --mock --verbose
```
